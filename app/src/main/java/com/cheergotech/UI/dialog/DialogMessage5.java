 ...
 * 弹窗提示消息
 */
public class DialogMessage5 extends BaseDialog {
    @BindView(R.id.title)
    TextView title;
    @BindView(R.id.msg)
    TextView msg;
    ...
    public static void show(Context context, CallBcak callBcak) {
        DialogMessage5 dialogMessage = new DialogMessage5(context, callBcak);
        dialogMessage.show();
    }

    public DialogMessage5(@NonNull Context context, CallBcak callBcak) {
        super(context);
