 ...
 * 选择上传图片
 */
public class DialogMessage13 extends BaseDialogShow {
    @BindView(R.id.send1)
    TextView send1;
    @BindView(R.id.send2)
    TextView send2;  @BindView(R.id.send3)
    TextView send3;

    public static void show(Context context, CallBcak callBcak) {
        DialogMessage13 dialogMessage = new DialogMessage13(context, callBcak);
        dialogMessage.show();
    }

    public DialogMessage13(@NonNull Context context, CallBcak callBcak) {
        super(context);
    ...
    @Override
    public int getview() {
        return R.layout.dialoig_item13;
    }
