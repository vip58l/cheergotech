 ...
 * Description
 */
public class holder130 extends BaseHolder {


    public holder130(Context context, ViewGroup parent, int viewType) {
        super(LayoutInflater.from(context).inflate(R.layout.item_holder130, parent, false));
    }
