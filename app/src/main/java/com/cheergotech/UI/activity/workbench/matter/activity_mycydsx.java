 ...
 * 事项-我参与的事项
 */
public class activity_mycydsx extends BaseActivity {
    ...
    public static void setAction(Context context) {
        ...
        intent.setClass(context, activity_mycydsx.class);
    ...
    public void iniview()  {
        ...
        backtitle.setconter("我参与的事项");
        for (int i = 0; i < 50; i++) {
            list.add("" + i);
        }
        recyclerview.setLayoutManager(new LinearLayoutManager(context));
        recyclerview.setAdapter(adapter = new Adapter(context, list, Adapter.type138, new CallBcak() {
            @Override
            public void Onfall() {
