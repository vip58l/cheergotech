 ...
 * 事项-已完成
 */
public class activity_completed extends BaseActivity {
    ...
    public static void setAction(Context context) {
        ...
        intent.setClass(context, activity_completed.class);
    ...
    public void iniview()  {
        ...
        backtitle.setconter("已完成");
        for (int i = 0; i < 50; i++) {
            list.add("" + i);
        }
        recyclerview.setLayoutManager(new LinearLayoutManager(context));
        recyclerview.setAdapter(adapter = new Adapter(context, list, Adapter.type140, new CallBcak() {
            @Override
            public void Onfall() {
