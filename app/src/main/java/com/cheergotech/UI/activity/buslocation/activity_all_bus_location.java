 ...
 * 校车位置 标注
 */
public class activity_all_bus_location extends BaseActivity {
    private static final String TAG = activity_all_bus_location.class.getName();
    ...
    public static void setAction(Activity context) {
        ...
        intent.setClass(context, activity_all_bus_location.class);
    ...
    public void iniview() {
        ...
        recyclerview.setAdapter(adapter = new Adapter(context, list, Adapter.bus_location, new CallBcak() {
            ...
            public void setOnClickListener(int position) {
                schoolbust schoolbust = (com.cheergotech.UI.model.schoolbust) list.get(position);
                recyclerview.setVisibility(View.GONE);
                findViewById(R.id.line1).performClick();
                Toasts.toastMessage(String.format("%s-%s", schoolbust.getDepartureStation(), schoolbust.getTerminusStation()));
            }
        }));
        recyclerview.setVisibility(View.GONE);
